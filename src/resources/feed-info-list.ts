...
export const FEED_INFO_LIST: FeedInfo[] = createFeedInfoList([
  ...
  ['QAを楽しむ者', 'https://note.com/qa_tpen/rss'],
  ...
  ['ソフトウェアテスト | Sqripts', 'https://sqripts.com/category/software-test/'],
  ['品質 | Sqripts', 'https://sqripts.com/category/quality/feed/'],
  ...
  ['つとむ QAエンジニア', 'https://note.com/26baca/rss'],
